...
import kodkod.examples.alloy.AbstractWorldDefinitions;
import kodkod.examples.alloy.CeilingsAndFloors;
import kodkod.examples.alloy.Dijkstra;
import kodkod.examples.alloy.FileSystem;
import kodkod.examples.alloy.Handshake;
import kodkod.examples.alloy.Hotel;
import kodkod.examples.alloy.Lists;
import kodkod.examples.alloy.Pigeonhole;
import kodkod.examples.alloy.RingElection;
import kodkod.examples.alloy.Toughnut;
import kodkod.examples.alloy.Trees;
import kodkod.examples.alloy.Bigconfig;
import kodkod.examples.tptp.ALG195;
import kodkod.examples.tptp.ALG197;
import kodkod.examples.tptp.ALG212;
import kodkod.examples.tptp.COM008;
import kodkod.examples.tptp.GEO091;
import kodkod.examples.tptp.GEO092;
import kodkod.examples.tptp.GEO115;
import kodkod.examples.tptp.GEO158;
import kodkod.examples.tptp.GEO159;
import kodkod.examples.tptp.LAT258;
import kodkod.examples.tptp.MED007;
import kodkod.examples.tptp.MED009;
import kodkod.examples.tptp.NUM374;
import kodkod.examples.tptp.NUM378;
import kodkod.examples.tptp.SET943;
import kodkod.examples.tptp.SET948;
import kodkod.examples.tptp.SET967;
import kodkod.examples.tptp.TOP020;
...
public class ExamplesTest extends TestCase {
    ...
    public ExamplesTest(String arg0) {
        ...
        this.solver.options().setSolver(SATFactory.DEFAULT);
    }
