...
import static kodkod.test.unit.OverflowTestUtils.assertInstance;
import static kodkod.test.unit.OverflowTestUtils.assertNoInstance;
import static kodkod.test.unit.OverflowTestUtils.max;
import static kodkod.test.unit.OverflowTestUtils.min;
...
public class OverflowTheoremTest extends TestCase {
    ...
    protected void setupOptions() {
        ...
        options.setSolver(SATFactory.DEFAULT);
     ...
     * UNSAT: some b: Int | all a: Int | b = MAXINT && (a = MAXINT => a+a = b+b) 
     * UNSAT: !(all b: Int | some a: Int | !(b = MAXINT && (a = MAXINT => a+a = b+b))) -
     * --- 
     * UNSAT: all x: Int | all a: Int | some b: Int | b = MAXINT && (a = MAXINT => a+a = b+b) 
     * UNSAT !(some x: Int | some a: Int | all b: Int | !(b = MAXINT && (a = MAXINT => a+a = b+b))) 
     * UNSAT: all x: Int | some b: Int | all a: Int | b = MAXINT && (a = MAXINT => a+a = b+b) 
     * UNSAT: !(some x: Int | all b: Int | some a: Int | !(b = MAXINT && (a = MAXINT => a+a = b+b)))
     */
