...
public abstract class TranslationTempNew extends HOLTranslation {

    /**========================================================================
     * Class HOLTranslationNew.FOL
     * ======================================================================== */
    public static class FOL extends TranslationTempNew {
        final Proc.FOL proc;
        final FOL prev;
        Translation folTr;
        ...
        @Override
        public TranslationTempNew next() {
     ...
     * ======================================================================== */
    public static class Some4All extends TranslationTempNew {
        ...
        class Solver implements SATSolver {
            ...
            public boolean solveNext()            {
                ...
                try {
                    log = new PrintWriter(new FileWriter(new File("cands_stat.txt")));
                ...
                while (candTr.cnf().solve()) {
                    ...
                    if (!checkTr.cnf().solve()) {
                        ...
                        log.println(cex.relationTuples().toString());
     ...
     * ======================================================================== */
    public static class OR extends TranslationTempNew {
    ...
    protected TranslationTempNew(Bounds bounds, Options options)            { this(bounds, options, 0); }
    protected TranslationTempNew(Bounds bounds, Options options, int depth) {
