...
public abstract class HOLTranslationOld extends HOLTranslation {
    ...
    public static class FOL extends HOLTranslationOld {
        ...
        public Formula formula()            { return annotated.node(); }
    ...
    public static class Some4All extends HOLTranslationOld {
        ...
        public Instance interpret()                       { return convTr.interpret(); }
        public Formula formula()                          { return convTr.formula(); }
        ...
        class Solver implements SATSolver {
            ...
            public boolean solveNext()            {
                ...
                while (convTr.cnf().solve()) {
                    ...
                    //TODO: rewrite check by replacing all skolems with concrete values from sol (maybe not necessary?)
    ...
    public Translation getCurrentLTLTranslation() { return null; }
